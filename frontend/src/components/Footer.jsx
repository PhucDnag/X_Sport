                ...
                <div className='flex flex-col md:flex-row justify-between gap-12'>
                    ...
                    <div className='md:w-1/2'>
                        <a href="/" className='inline-block mb-6'>
                            <img src={assets.logo} className='w-40' alt="X-Sport Logo" />
                        </a>
                        <p className='text-gray-300 text-base leading-relaxed mb-6 max-w-md'>
                            X-Sport cam kết mang đến cho khách hàng những sản phẩm thể thao chính hãng, đa dạng, phù hợp với thể trạng người Việt. Chúng tôi luôn đặt chất lượng và sự hài lòng của bạn lên hàng đầu.                    </p>
                    ...
                    <div className='md:w-1/2 flex flex-col sm:flex-row justify-between gap-8'>
                        ...
                        <div>
                            ...
                            <ul className='space-y-3'>
                                ...
                                <li>
                                    <a href="/shipping" className='text-gray-300 hover:text-white hover:translate-x-1 transition-all duration-200 flex items-center gap-2'>
                                        <span className='text-blue-400'>→</span>
                                        Phương thức vận chuyển
                                    </a>
                                </li>
                                <li>
                                    <a href="/privacy" className='text-gray-300 hover:text-white hover:translate-x-1 transition-all duration-200 flex items-center gap-2'>
                                        <span className='text-blue-400'>→</span>
                                        Chính sách bảo mật
                                    </a>
                                </li>
                        ...
                        <div>
                            ...
                            <div className='space-y-4'>
                                <div className='flex items-center gap-3 text-gray-300'>
                                    ...
                                    <p /*href="tel:"*/ className='hover:text-white transition-colors'>
                                        Số điện thoại demo
                                    </p>
                                </div>
                                ...
                                <div className='flex items-center gap-3 text-gray-300'>
                                    ...
                                    <p /*href="mailto:"*/ className='hover:text-white transition-colors break-all'>
                                        Email demo
                                    </p>
                                </div>
                                ...
                                <div className='flex items-start gap-3 text-gray-300'>
                                    ...
                                    <span className='leading-relaxed hover:text-white'>
                                        Địa chỉ cửa hàng demo
                                    </span>
                                </div>
                            </div>
                        </div>
                ...
                <div className='max-w-6xl mx-auto px-4 py-4'>
                    <div className='flex flex-col md:flex-row justify-between items-center gap-4'>
                        <p className='text-gray-400 text-sm'>
                            © 2025 X-Sport. Tất cả quyền được bảo lưu.
                        </p>
