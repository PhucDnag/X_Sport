        ...
        <div className='relative w-full sm:w-1/2 flex items-center justify-center p-10 sm:p-16 lg:p-20'>
            <div className='text-gray-800 max-w-lg'>
                ...
                <p className='text-gray-600 text-lg mb-8 leading-relaxed'>
                    "Khám phá bộ sưu tập vợt cầu lông mới nhất với thiết kế hiện đại, hiệu năng vượt trội và chất lượng được đảm bảo. Từng sản phẩm đều được chọn lọc kỹ lưỡng, mang đến cho bạn trải nghiệm thi đấu tốt nhất, phù hợp cho cả người chơi phong trào lẫn vận động viên chuyên nghiệp."
                </p>
                ...
                <div className='flex items-center gap-3 group cursor-pointer'>
                    ...
                    <NavLink to='/collection' className='font-semibold text-lg text-gray-800 group-hover:text-blue-600 transition-colors'>Mua sắm ngay</NavLink>
            ...
            <div className='relative h-full'>
                ...
                <div className='absolute bottom-8 left-8 bg-white/90 backdrop-blur-sm rounded-2xl p-6 shadow-lg max-w-xs'>
                    <div className='flex items-center gap-3'>
                        ...
                        <div>
                            <p className='text-sm font-semibold text-gray-800'>3500+</p>
